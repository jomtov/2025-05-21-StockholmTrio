...
address: "Canceled"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "59.363777"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "18.061451"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Canceled"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "Canceled"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2025-00-00      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2025-00-00        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Mattias Vesterlund", "Glenn Haya", "Merlijn de Smit"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Joakim Philipson"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: ["https://pad.carpentries.org/2025-05-21-StockholmTrioLibraries"] # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
<p id="sign-up">
  ...
  Canceled <a href="https://su.se/Canceled">Canceled.</a>
</p>
